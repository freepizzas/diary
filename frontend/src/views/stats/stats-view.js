    ...
    static get template() {
        return html`
            ...
            <vaadin-horizontal-layout theme="spacing" style="width: 100%; height: 100%;" id="vaadinHorizontalLayout">
                <vaadin-vertical-layout theme="spacing" style="width: 75%; height: 100%;"
                                        id="vaadinVerticalLayout"></vaadin-vertical-layout>
                    ...
                    <vaadin-horizontal-layout theme="spacing" style="width: 100%; height: 100%;">
                        <div class="center-top">
                            <vaadin-chart title="Moods by Dates" categories="" id="moodChart">
                                <vaadin-chart-series title="Moods" unit="Worst to Best [1-5]"
                                                     values=""></vaadin-chart-series>
                            </vaadin-chart>
                        </div>
